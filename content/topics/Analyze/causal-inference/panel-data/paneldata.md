...
The following code estimates this fixed effects equation in R. Please refer to the [`fixest` article](fixest.md) for a thorough explanation on this fixed effects regression in R and the package `fixest` in general.
