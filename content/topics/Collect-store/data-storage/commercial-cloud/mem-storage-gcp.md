...
In this article, we build upon the foundational steps outlined in [Configure a VM with GPUs in Google Cloud](../../../Automation/Replicability/cloud-computing/config-VM-GCP.md).
